...
if [ -e 4_unitigs_bifrost.sh ]; then
    bash 4_unitigs_bifrost.sh;
fi
if [ -e 4_anchors.sh ]; then
    bash 4_anchors.sh 4_unitigs_bifrost;
fi
if [ -e 9_stat_anchors.sh ]; then
    bash 9_stat_anchors.sh 4_unitigs_bifrost statUnitigsBifrost.md
fi
...
if [ -e 6_unitigs_bifrost.sh ]; then
    bash 6_unitigs_bifrost.sh;
fi
if [ -e 6_anchors.sh ]; then
    bash 6_anchors.sh 6_unitigs_bifrost;
fi
if [ -e 9_stat_anchors.sh ]; then
    bash 9_stat_mr_anchors.sh 6_unitigs_bifrost statMRUnitigsBifrost.md
fi
...
if [ -e 7_merge_anchors.sh ]; then
    bash 7_merge_anchors.sh 4_unitigs_bifrost 7_merge_unitigs_bifrost;
fi
if [ -e 7_merge_anchors.sh ]; then
...
if [ -e 7_merge_anchors.sh ]; then
    bash 7_merge_anchors.sh 6_unitigs_bifrost 7_merge_mr_unitigs_bifrost
fi
if [ -e 7_merge_anchors.sh ]; then
